  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        'heading': ['Montserrat', 'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'sans-serif']
      },
      fontSize: {
        ...
        '3xl': ['clamp(1.875rem, 1.5rem + 1.25vw, 2.25rem)'],
        '4xl': ['clamp(2.25rem, 1.75rem + 1.5vw, 3rem)']
      },
      fontWeight: {
        'light': 300,
        'normal': 400,
