          ...
          <div className="lg:w-1/2 z-10">
            <div className="max-w-xl">
              <h1 id="hero-title" className="text-5xl lg:text-6xl font-bold mb-6 opacity-0 animate-fade-in-left">
                <span className="text-primary-cyan">Un préstamo accesible</span>
                <br /> 
                <span className="text-primary-navy">pensado para ti</span>
              </h1>
              <p className="text-xl text-gray-600 mb-12 opacity-0 animate-fade-in-left" style={{ animationDelay: '100ms' }}>
                Realiza tus sueños en <span className="text-primary-cyan font-semibold">SoluPresta</span>
              </p>
              ...
              <div className="opacity-0 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                <Link 
                  to="/loan-application" 
                  className="inline-flex items-center bg-primary-cyan hover:bg-primary-navy text-white font-bold py-4 px-8 rounded-full transition-all duration-300 hover:scale-105 focus:ring-2 focus:ring-primary-cyan focus:ring-offset-2 focus:ring-offset-white group shadow-lg hover:shadow-primary-cyan/20"
                >
                  SOLICITAR AHORA
                  <svg 
              ...
              <div className="absolute -bottom-8 right-8 bg-white/80 backdrop-blur-md p-6 rounded-xl shadow-xl z-20 opacity-0 animate-fade-in-up" style={{ animationDelay: '600ms' }}>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-primary-navy">15.99% anual</p>
                  </div>
                </div>
              </div>
            </div>
