  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="text-xl font-semibold text-primary-navy mb-4 transition-colors duration-500 group-hover:text-primary-cyan">
          {title}
        </h3>
  ...
  const contactInfo = [
    {
      ...
      title: "Teléfonos",
      details: ["(55) 8128-9583", "(55) 7822-8820"]
    },
    {
      icon: <Mail className="w-6 h-6" />,
      title: "Correo Electrónico",
      details: ["atencion@prestamomico.com"]
    },
    {
